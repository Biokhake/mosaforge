...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0b0c0e" },
      {
        name: "description",
        content:
          "MOSA Forge — part sculpt studio. Stack low-poly solids on a slot socket, export a recipe the hangar can mix.",
      },
    ],
    links: [
  ...
  component: () => (
    <html lang="ko" className="theme-dark" suppressHydrationWarning>
      <head>
        <HeadContent />
      </head>
